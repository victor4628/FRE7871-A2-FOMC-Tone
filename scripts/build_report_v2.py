...
def build():
    ...
    story+=[tbl(rm,[2.2*inch,1.4*inch,1.4*inch],align_right=(1,2)),Spacer(1,7),
            ...
            P('The four market-direction probabilities remain close to 50%, and the expected changes are small relative to residual uncertainty. These are low-confidence model outputs for academic analysis only; no investment recommendation is made.','Call'),PageBreak(),
